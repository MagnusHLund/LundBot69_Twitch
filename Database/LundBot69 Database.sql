...
CREATE TABLE IF NOT EXISTS `Commands` (
  ...
  UNIQUE KEY `name_unique` (`creator_id`,`name`),
  KEY `commands_fk_1` (`creator_id`),
  CONSTRAINT `commands_fk_1` FOREIGN KEY (`creator_id`) REFERENCES `Creators` (`creator_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `CommandUserCooldowns` (
  ...
  UNIQUE KEY `used_by_unique` (`command_id`,`used_by`),
  KEY `command_user_cooldowns_fk_1` (`command_id`),
  CONSTRAINT `command_user_cooldowns_fk_1` FOREIGN KEY (`command_id`) REFERENCES `Commands` (`command_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `DefaultSongs` (
  ...
  UNIQUE KEY `play_order_unique` (`creator_id`,`play_order`),
  KEY `Default_Songs_fk_1` (`creator_id`),
  CONSTRAINT `Default_Songs_fk_1` FOREIGN KEY (`creator_id`) REFERENCES `Creators` (`creator_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `Giveaways` (
  ...
  UNIQUE KEY `participant_unique` (`creator_id`,`participant`),
  KEY `Giveaways_fk_1` (`creator_id`),
  CONSTRAINT `Giveaways_fk_1` FOREIGN KEY (`creator_id`) REFERENCES `Creators` (`creator_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `Messages` (
  ...
  UNIQUE KEY `name_unique` (`creator_id`,`name`),
  KEY `Messages_fk_1` (`creator_id`),
  CONSTRAINT `Messages_fk_1` FOREIGN KEY (`creator_id`) REFERENCES `Creators` (`creator_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `Points` (
  ...
  UNIQUE KEY `twitch_username_unique` (`creator_id`,`twitch_username`),
  KEY `points_index` (`points`),
  KEY `points_fk_1` (`creator_id`),
  CONSTRAINT `points_fk_1` FOREIGN KEY (`creator_id`) REFERENCES `Creators` (`creator_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `Settings` (
  ...
  KEY `settings_fk_1` (`creator_id`),
  CONSTRAINT `settings_fk_1` FOREIGN KEY (`creator_id`) REFERENCES `Creators` (`creator_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `SongRequestBannedAccounts` (
  ...
  UNIQUE KEY `twitch_username_unique` (`twitch_username`,`creator_id`),
  KEY `song_request_banned_accounts_fk_1` (`creator_id`),
  CONSTRAINT `song_request_banned_accounts_fk_1` FOREIGN KEY (`creator_id`) REFERENCES `Creators` (`creator_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `SongRequestBannedSongs` (
  ...
  UNIQUE KEY `youtube_video_id_unique` (`youtube_video_id`,`creator_id`),
  KEY `song_request_banned_songs_fk_1` (`creator_id`),
  CONSTRAINT `song_request_banned_songs_fk_1` FOREIGN KEY (`creator_id`) REFERENCES `Creators` (`creator_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `SongRequests` (
  ...
  KEY `SongRequests_fk_1` (`creator_id`),
  CONSTRAINT `SongRequests_fk_1` FOREIGN KEY (`creator_id`) REFERENCES `creators` (`Creator_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;